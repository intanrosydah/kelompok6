...
<html lang="en">
  <head>
    ...
    <title>Tantangan Harian - Hari Ke-5</title>
    ...
    <main class="container my-5">
      <div class="card bg-white p-4 rounded shadow-sm mx-auto col-12 col-md-8">
        <div class="text-center text-dark mt-5">
          <h2>Tantangan Harian - Hari Ke-5</h2>
        ...
        <div class="border border-3 border-info-subtle rounded p-4 mt-3">
          <p class="fw-bold text-center text-dark">Buat program untuk mengonversi berat dari kilogram ke gram. Dengan bahasa pythondan input dari user.</p>
          <textarea class="form-control mb-3" placeholder="Tulis kode Anda..." style="height: 150px;"
            >
            # Program konversi berat dari kilogram ke gram
            ...
            # Output
            print(f"Berat dalam gram: {gram:.0f}")
          </textarea>
          <div class="mt-2">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content text-center">
                  ...
                  <div class="modal-footer justify-content-center">
                    <a href="kode-daily-coding-hari5.html" class="btn btn-success">Lanjut</a>
                  </div>
                </div>
              </div>
            </div>
            <a href="daily-coding-hari6.html" class="btn btn-dark ms-2">Lanjut Hari Berikutnya</a>
          </div>
      </div>
