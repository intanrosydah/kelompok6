...
<html lang="en">
  <head>
    ...
    <title>Tantangan Harian - Hari Ke-6</title>
    ...
    <main class="container my-5">
      <div class="card bg-white p-4 rounded shadow-sm mx-auto col-12 col-md-8">
        <div class="text-center text-dark mt-5">
          <h2>Tantangan Harian - Hari Ke-6</h2>
        ...
        <div class="border border-3 border-primary rounded p-4 mt-3">
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content text-center">
                      ...
                      <div class="modal-footer justify-content-center">
                        <a href="kode-daily-coding-hari6.html" class="btn btn-success">Lanjut</a>
                      </div>
                    </div>
                  </div>
                </div>
                <a href="daily-coding-hari7.html" class="btn btn-dark ms-2">Lanjut Hari Berikutnya</a>
              </div>
          </div>
